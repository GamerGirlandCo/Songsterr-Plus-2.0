...
function s (n, t, _) {
  var r,
    ...
    l,
    u = {}
  for (l in t) 'key' == l ? (r = t[l]) : 'ref' == l ? (o = t[l]) : (u[l] = t[l])
  if (
    (arguments.length > 2 &&
...
function P (e, n, t) {
  for (var _, r = e.__k, o = 0; r && o < r.length; o++)
    (_ = r[o]) &&
      ((_.__ = e),
      (n = 'function' == typeof _.type ? P(_, n, t) : S(t, _, _, r, _.__e, n)))
  return n
}
function C (e, n) {
  return (
...
function x (e, n, t) {
  '-' === n[0]
    ? e.setProperty(n, t)
    : (e[n] = null == t ? '' : 'number' != typeof t || c.test(n) ? t : t + 'px')
}
function w (e, n, t, _, r) {
  var o
  e: if ('style' === n)
    ...
    (o = n !== (n = n.replace(/Capture$/, ''))),
      ...
      (e.l[n + o] = t),
      t
        ? _ || e.addEventListener(n, o ? E : H, o)
        : e.removeEventListener(n, o ? E : H, o)
  ...
  if (null === v) h === d || (c && n.data === d) || (n.data = d)
    ...
    if (
      ((function (e, n, t, _, r) {
        var o
        for (o in t)
          'children' === o || 'key' === o || o in n || w(e, o, null, t[o], _)
        for (o in n)
    ...
    c ||
      ('value' in d &&
        void 0 !== (m = d.value) &&
        (m !== h.value || m !== n.value || ('progress' === v && !m)) &&
...
;(n.unmount = function (e) {
  ...
  ((Pe.prototype = new v()).__c = function (e, n) {
    var t = n.__c,
      _ = this
...
;((xe.prototype = new v()).__e = function (e) {
  ...
  return (
    ...
    function (r) {
      var o = function () {
        n.props.revealOrder ? (_.push(r), we(n, e, _)) : r()
      }
      t ? t(o) : o()
    }
  )
...
var He =
    ...
    60103,
  Ee = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,
    ...
    for (var o in ((_ = {}), t)) {
      ...
      ;(Ae && 'children' === o && 'noscript' === n) ||
        ...
        ('defaultValue' === o && 'value' in t && null == t.value
          ...
          ? (o = 'ondblclick')
          : /^onchange(textarea|input)/i.test(o + n) && !Ue(t.type)
          ? (o = 'oninput')
          : /^onfocus$/i.test(o)
          ? (o = 'onfocusin')
          : /^onblur$/i.test(o)
...
//# sourceMappingURL=preact.89f2d999.js.map
