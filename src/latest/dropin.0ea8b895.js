...
var eL = eN,
  ...
  eR = { YES: "Yes", NO: "No", UNKNOWN: "Unknown" },
  eV = { PSDTWO: "psd2" };
function ez(e) {
      ...
      creditCards: [
        {
          ...
          details: {
            ...
            bin: i.bin || "",
            cardType: ek[i.brandCode] || "Unknown",
            lastFour: i.last4 || "",
            lastTwo: a,
          },
          type: "CreditCard",
...
(tU.prototype.catch = function (e) {
  ...
  (tU.all = function (e) {
    return new tU(function (t, n) {
      if (!tR(e)) return n(TypeError("Promise.all accepts an array"));
      var r = Array.prototype.slice.call(e);
      if (0 === r.length) return t([]);
      for (var i = r.length, a = 0; a < r.length; a++)
        !(function e(a, o) {
  ...
  (tU.race = function (e) {
    return new tU(function (t, n) {
      if (!tR(e)) return n(TypeError("Promise.race accepts an array"));
...
function rR(e) {
  return e.authorization
    ...
    : rL.reject(
        new rF({
          type: rk.INSTANTIATION_OPTION_REQUIRED.type,
          code: rk.INSTANTIATION_OPTION_REQUIRED.code,
          message:
            "options.authorization is required when instantiating a client.",
        })
      );
}
var rV = { create: rS(rR), VERSION: rw },
  rz = P.atob,
  rU = C,
  rH = rV.VERSION;
function rB(e) {
        ...
        r = ik
          ...
          .then(function (e) {
            return e.getConfiguration().gatewayConfiguration.applePayWeb
              ...
              : iR.reject(new iw(iV.APPLE_PAY_NOT_ENABLED));
          });
...
var aS = a_,
  ak = ap;
function aR(e, t, n) {
  for (var r = ak.childWindows.length - 1; r >= 0; r--) {
    var i = ak.childWindows[r];
    i.closed
      ? ak.childWindows.splice(r, 1)
      : n !== i && (0, aS.broadcast)(e, { origin: t, frame: i.top });
  }
}
(aL.broadcastToChildWindows = aR),
...
var oV = function (e) {
    return ok((e = e || window.navigator.userAgent)) && oR(e);
  },
  oz = oc,
  oU = oV,
  oH = function (e) {
  ...
  return (
    sV.hasOwnProperty(e)
      ? null == t ||
        sU(e, t) ||
        (n = new sk({
          type: sR.HOSTED_FIELDS_ATTRIBUTE_VALUE_NOT_ALLOWED.type,
          code: sR.HOSTED_FIELDS_ATTRIBUTE_VALUE_NOT_ALLOWED.code,
          message:
            'Value "' + t + '" is not allowed for "' + e + '" attribute.',
        }))
      : (n = new sk({
          type: sR.HOSTED_FIELDS_ATTRIBUTE_NOT_SUPPORTED.type,
          code: sR.HOSTED_FIELDS_ATTRIBUTE_NOT_SUPPORTED.code,
          message:
...
var dk = L;
dx.isIE9 = dk;
var dR = /Version\/\d\.\d* Chrome\/\d*\.0\.0\.0/;
function dV(e) {
  return !dL(e) && e.indexOf("Samsung") > -1;
}
function dz(e) {
  return void 0 === e && (e = dF), dM(e) && dR.test(e);
}
function dU(e) {
...
function cH(e) {
  return !cS(e) && !ck(e) && /samsung/i.test(e);
}
var cB = function (e) {
  return !(
...
function pz(e) {
  return pS
    ...
    .then(function () {
      return new pR(e)._initialize(e);
    });
}
function pU() {
  return !0;
}
var pH = { create: pk(pz), isSupported: pU, VERSION: pV },
  pB = {
...
(uH.prototype = Object.create(uU.prototype)),
  ...
  (uH.isEnabled = function (e) {
    return e.merchantConfiguration.paypalCredit
      ? uU.isEnabled(uR({ viewID: uH.ID }, e))
      : uV.resolve(!1);
  });
var uB = uH,
  uj = D,
  ...
  hz = (function () {
    ...
    return (
      ...
      (e.prototype.createPaymentContextFromGraphqlLegacyQRCodeMutation =
        function (e) {
          return this.apiRequest(hk.LEGACY_CREATE_PAYMENT_CONTEXT_QUERY, {
      ...
      (e.prototype.createPaymentContextFromGraphQL = function (e) {
        ...
        return (
          ...
          this.apiRequest(hk.CREATE_PAYMENT_CONTEXT_QUERY, { input: t }).then(
            function (e) {
      ...
      (e.prototype.updateVenmoDesktopPaymentContext = function (e, t) {
        ...
        var n = { input: hx({ id: this.venmoContextId, status: e }, t) },
          r = this.shouldUseLegacyQRCodeMutation
            ? hk.LEGACY_UPDATE_PAYMENT_CONTEXT_QUERY
            : hk.UPDATE_PAYMENT_CONTEXT_QUERY;
      ...
      (e.prototype.lookupVenmoDesktopPaymentContext = function () {
        ...
        var e = this.shouldUseLegacyQRCodeMutation
          ? hk.LEGACY_VENMO_PAYMENT_CONTEXT_STATUS_QUERY
          : hk.VENMO_PAYMENT_CONTEXT_STATUS_QUERY;
  ...
  (mj.prototype.deletePaymentMethod = function (e) {
    return this._createPromise.then(function (t) {
      return "CLIENT_TOKEN" !== t.getConfiguration().authorizationType
        ? mU.reject(
            new mk(
              mR.VAULT_MANAGER_DELETE_PAYMENT_METHOD_NONCE_REQUIRES_CLIENT_TOKEN
            )
          )
        : t
            .request({
            ...
            .catch(function (n) {
              ...
              return (
                ...
                i[0] &&
                  ...
                  (r = new mk({
                    type: mR.VAULT_MANAGER_PAYMENT_METHOD_NONCE_NOT_FOUND.type,
                    code: mR.VAULT_MANAGER_PAYMENT_METHOD_NONCE_NOT_FOUND.code,
                    message:
                ...
                r ||
                  (r = new mk({
                    type: mR.VAULT_MANAGER_DELETE_PAYMENT_METHOD_UNKNOWN_ERROR
                      .type,
                    code: mR.VAULT_MANAGER_DELETE_PAYMENT_METHOD_UNKNOWN_ERROR
                      .code,
                    message:
...
function yD() {
  yC.apply(this, arguments), this._initialize();
}
(yD.prototype = Object.create(yC.prototype)),
  (yD.prototype.constructor = yD),
  (yD.prototype._initialize = function () {
    var e,
      t = yI,
      n = yT.paymentMethodCardTypes,
      r = yT.paymentMethodTypes;
    switch (
  ...
  (yD.prototype.setActive = function (e) {
    setTimeout(
      function () {
        yb.toggle(this.element, "braintree-method--active", e);
      }.bind(this),
      0
    );
  }),
  (yD.prototype.enableEditMode = function () {
    yb.add(this.checkMark, "braintree-hidden"),
      this.paymentMethod.hasSubscription &&
        yb.add(this.element, "braintree-method--disabled");
  }),
  (yD.prototype.disableEditMode = function () {
    yb.remove(this.checkMark, "braintree-hidden"),
      yb.remove(this.element, "braintree-method--disabled");
  }),
  (yD.prototype.teardown = function () {
    this.element.parentNode &&
      this.element.parentNode.removeChild(this.element);
  }),
  (yD.prototype._choosePaymentMethod = function () {
    this.paymentMethod.vaulted &&
      yP.sendEvent(
        this.client,
        "vaulted-" + yT.analyticsKinds[this.paymentMethod.type] + ".select"
      ),
      this.model.changeActivePaymentMethod(this.paymentMethod);
  }),
  (yD.prototype._selectDelete = function () {
...
function yR() {
  yO.apply(this, arguments), this._initialize();
}
(yR.prototype = Object.create(yO.prototype)),
  (yR.prototype.constructor = yR),
  (yR.ID = yR.prototype.ID = "methods"),
  (yR.prototype._initialize = function () {
    (this.views = []),
      ...
      this.model.merchantConfiguration.vaultManager &&
        ...
        yM.remove(this._editButton, "braintree-hidden"));
  }),
  (yR.prototype.removeActivePaymentMethod = function () {
    this.activeMethodView &&
      (this.activeMethodView.setActive(!1),
      (this.activeMethodView = null),
      yM.add(this._headingLabel, "braintree-no-payment-method-selected"));
  }),
  (yR.prototype._getPaymentMethodString = function () {
    var e, t;
  ...
  (yR.prototype.enableEditMode = function () {
    yM.add(this.container, "braintree-methods--edit"),
  ...
  (yR.prototype.disableEditMode = function () {
    yM.remove(this.container, "braintree-methods--edit"),
  ...
  (yR.prototype._addPaymentMethod = function (e) {
    var t = new yx({
      model: this.model,
      paymentMethod: e,
      client: this.client,
  ...
  (yR.prototype._removePaymentMethod = function (e) {
    var t;
  ...
  (yR.prototype._changeActivePaymentMethodView = function (e) {
    var t,
    ...
    n && n.setActive(!1),
      ...
      yM.remove(this._headingLabel, "braintree-no-payment-method-selected");
  }),
  (yR.prototype.requestPaymentMethod = function () {
    return !this.activeMethodView || this.model.isInEditMode()
      ? yL.reject(new yF(yw.NO_PAYMENT_METHOD_ERROR))
      : yL.resolve(this.activeMethodView.paymentMethod);
  }),
  (yR.prototype.refreshPaymentMethods = function () {
    var e,
...
var yV = yR,
  yz = it,
  yU = m0,
  yH = C.paymentMethodTypes;
function yB() {
  yz.apply(this, arguments), this._initialize();
}
(yB.prototype = Object.create(yz.prototype)),
  (yB.prototype.constructor = yB),
  (yB.ID = yB.prototype.ID = "delete-confirmation"),
  (yB.prototype._initialize = function () {
  ...
  (yB.prototype.applyPaymentMethod = function (e) {
    var t,
      n,
  ...
  (yB.prototype.onSelection = function () {
...
var yY = { delay: yK },
  ...
  y4 = yY,
  y5 = yG,
  y6 = C.CHANGE_ACTIVE_PAYMENT_METHOD_TIMEOUT,
  y7 = C.errors.DEVELOPER_MISCONFIGURATION_MESSAGE;
function y8() {
  yZ.apply(this, arguments),
...
(y8.prototype = Object.create(yZ.prototype)),
  (y8.prototype.constructor = y8),
  (y8.prototype._initialize = function () {
    var e;
    (this._hasMultiplePaymentOptions =
      ...
      (this.paymentSheetViewIDs = Object.keys(yX).reduce(
        function (e, t) {
          var n, r;
          return (
      ...
      (this.paymentMethodsViews = new y$({
      ...
      (this.deleteConfirmationView = new y0({
        element: this.getElementById("delete-confirmation"),
        model: this.model,
        strings: this.strings,
      })),
      this.addView(this.deleteConfirmationView),
      y2(this.toggle, this.toggleAdditionalOptions.bind(this)),
      this.model.on(
        "changeActivePaymentMethod",
        function () {
          y4.delay(y6).then(
      ...
      this._hasMultiplePaymentOptions &&
        ((e = new y1({
          client: this.client,
          element: this.getElementById(y1.ID),
          mainView: this,
          model: this.model,
          strings: this.strings,
        })),
  ...
  (y8.prototype._onChangeActiveView = function (e) {
    var t = e.newViewId,
      n = this.getView(t);
    t === y$.ID
      ? (yJ.add(
        ...
        yJ.remove(this.sheetContainer, "braintree-sheet--active"))
      : (y4.delay(0).then(
          function () {
            yJ.add(this.sheetContainer, "braintree-sheet--active");
          }.bind(this)
        ),
        yJ.remove(
          this.paymentMethodsViews.container,
  ...
  (y8.prototype.addView = function (e) {
    this._views[e.ID] = e;
  }),
  (y8.prototype.getView = function (e) {
    return this._views[e];
  }),
  (y8.prototype.setPrimaryView = function (e, t) {
    var n;
    y4.delay(0).then(
      function () {
        (this.element.className = fe(e)), t && yJ.add(this.element, fe(t));
      }.bind(this)
    ),
      (this.primaryView = this.getView(e)),
      this.model.changeActiveView(e),
      -1 !== this.paymentSheetViewIDs.indexOf(e)
        ? this.model.getPaymentMethods().length > 0 || this.getView(y1.ID)
          ? this.showToggle()
          : this.hideToggle()
        : e === y$.ID
        ? (this.showToggle(),
  ...
  (y8.prototype.requestPaymentMethod = function () {
    return this.getView(this.model.getActivePaymentViewId())
      .requestPaymentMethod()
      .then(
        function (e) {
          return (
            yq.sendEvent(this.client, "request-payment-method." + yQ[e.type]), e
          );
        }.bind(this)
      )
      .catch(
  ...
  (y8.prototype.hideLoadingIndicator = function () {
    yJ.remove(this.dropinContainer, "braintree-loading"),
      yJ.add(this.dropinContainer, "braintree-loaded"),
      yJ.add(this.loadingContainer, "braintree-hidden");
  }),
  (y8.prototype.showLoadingIndicator = function () {
    yJ.add(this.dropinContainer, "braintree-loading"),
      yJ.remove(this.dropinContainer, "braintree-loaded"),
      yJ.remove(this.loadingContainer, "braintree-hidden");
  }),
  (y8.prototype.toggleAdditionalOptions = function () {
    var e,
      ...
      this._hasMultiplePaymentOptions
        ? t
          ? 0 === this.model.getPaymentMethods().length
            ? this.setPrimaryView(y1.ID)
            : (this.setPrimaryView(y$.ID, y1.ID), this.hideToggle())
          : yJ.add(this.element, fe(y1.ID))
        : ((e = this.paymentSheetViewIDs[0]),
          yJ.add(this.element, fe(e)),
          this.model.changeActiveView(e));
  }),
  (y8.prototype.showToggle = function () {
    this.model.isInEditMode() ||
      (yJ.remove(this.toggle, "braintree-hidden"),
      yJ.add(this.lowerContainer, "braintree-hidden"));
  }),
  (y8.prototype.hideToggle = function () {
    yJ.add(this.toggle, "braintree-hidden"),
      yJ.remove(this.lowerContainer, "braintree-hidden");
  }),
  (y8.prototype.showSheetError = function (e) {
    var t,
      n = this.strings.genericError;
    (t = this.strings.hasOwnProperty(e)
      ? this.strings[e]
      : e && "string" == typeof e.code
      ? this.strings[y9(e.code) + "Error"] || n
      : "developerError" === e
      ? y7
      : n),
      yJ.add(this.dropinContainer, "braintree-sheet--has-error"),
      (this.sheetErrorText.innerHTML = t);
  }),
  (y8.prototype.hideSheetError = function () {
    yJ.remove(this.dropinContainer, "braintree-sheet--has-error");
  }),
  (y8.prototype.getOptionsElements = function () {
    return this._views.options.elements;
  }),
  (y8.prototype.preventUserAction = function () {
    yJ.remove(this.disableWrapper, "braintree-hidden");
  }),
  (y8.prototype.allowUserAction = function () {
    yJ.add(this.disableWrapper, "braintree-hidden");
  }),
  (y8.prototype.teardown = function () {
    var e,
    ...
    return y3.all(t).then(function () {
      return e ? y3.reject(e) : y3.resolve();
    });
  }),
  (y8.prototype.enableEditMode = function () {
    this.setPrimaryView(this.paymentMethodsViews.ID),
      this.paymentMethodsViews.enableEditMode(),
      this.hideToggle(),
      this.model.setPaymentMethodRequestable({ isRequestable: !1 });
  }),
  (y8.prototype.disableEditMode = function () {
    var e;
    this.hideSheetError(),
  ...
  (y8.prototype.openConfirmPaymentMethodDeletionDialog = function (e) {
    this.deleteConfirmationView.applyPaymentMethod(e),
      this.setPrimaryView(this.deleteConfirmationView.ID);
  }),
  (y8.prototype.cancelVaultedPaymentMethodDeletion = function () {
    this.setPrimaryView(this.paymentMethodsViews.ID);
  }),
  (y8.prototype.startVaultedPaymentMethodDeletion = function () {
    (this.element.className = ""), this.showLoadingIndicator();
  }),
  (y8.prototype.finishVaultedPaymentMethodDeletion = function (e) {
    var t = this;
    return (
      ...
      e && this.model.getPaymentMethods().length > 0
        ...
        : this._sendToDefaultView(),
      new y3(function (e) {
        y4.delay(500).then(function () {
          t.hideLoadingIndicator(), e();
        });
      })
    );
  }),
  (y8.prototype._sendToDefaultView = function () {
...
(fs.prototype.initialize = function () {
  var e = this;
  return fo
    .resolve()
    .then(function () {
      ...
      return h.braintree && h.braintree.dataCollector
        ...
        : ((t = e._config.client.getVersion()),
          fa.loadScript({
            ...
            id: fr.DATA_COLLECTOR_SCRIPT_ID,
          }));
    })
    .then(function () {
    ...
    .catch(function (t) {
      fi.sendEvent(e._config.client, "data-collector.setup-failed"), e.log(t);
    });
}),
  (fs.prototype.log = function (e) {
    console.log(e);
  }),
  (fs.prototype.getDeviceData = function () {
    return this._instance ? this._instance.deviceData : "";
  }),
  (fs.prototype.teardown = function () {
    return this._instance ? this._instance.teardown() : fo.resolve();
  });
var fd = fs,
  fl = D,
  fc = {
    THREEDS_NOT_ENABLED: {
      type: fl.types.MERCHANT,
  ...
  fu = T,
  fh = fu(["AUTHENTICATION_COMPLETE"], "threedsecure:"),
  fm = ey.assign,
  fy = nG,
  ff = D,
  fE = t0,
  ...
  fI = fh,
  fD = a4,
  fN = nd.BUS_CONFIGURATION_REQUEST_EVENT,
  fO = "3.90.0",
  fx = 400,
  fF = 400;
function fM(e) {
  fg.call(this),
    ...
    (this._assetsUrl = this._assetsUrl + "/web/" + fO);
}
fg.createChild(fM),
  (fM.prototype._waitForClient = function () {
    return this._client
      ? fE.resolve()
      : this._createPromise.then(
          function (e) {
  ...
  (fM.prototype.setUpEventListeners = function () {
    throw new ff(fP.THREEDS_FRAMEWORK_METHOD_NOT_IMPLEMENTED);
  }),
  (fM.prototype.verifyCard = function (e, t) {
    var n,
      r,
      i = this;
  ...
  (fM.prototype._checkForFrameworkSpecificVerifyCardErrors = function () {
    throw new ff(fP.THREEDS_FRAMEWORK_METHOD_NOT_IMPLEMENTED);
  }),
  (fM.prototype._presentChallenge = function () {
    throw new ff(fP.THREEDS_FRAMEWORK_METHOD_NOT_IMPLEMENTED);
  }),
  (fM.prototype.prepareLookup = function () {
    throw new ff(fP.THREEDS_FRAMEWORK_METHOD_NOT_IMPLEMENTED);
  }),
  (fM.prototype._resetVerificationState = function () {
    (this._verifyCardInProgress = !1), (this._verifyCardPromisePlus = null);
  }),
  (fM.prototype._performLookup = function (e, t) {
    var n = this,
    ...
    return this._waitForClient().then(function () {
      return n._client
        ...
        .catch(function (e) {
          ...
          return (
            404 === r
              ? ((t = fP.THREEDS_LOOKUP_TOKENIZED_CARD_NOT_FOUND_ERROR),
                (i += ".404"))
              : 422 === r
              ? ((t = fP.THREEDS_LOOKUP_VALIDATION_ERROR), (i += ".422"))
              : (t = fP.THREEDS_LOOKUP_ERROR),
            fy.sendEvent(n._createPromise, i),
            fE.reject(
              new ff({
                type: t.type,
                code: t.code,
  ...
  (fM.prototype._checkForVerifyCardError = function (e, t) {
    var n;
    return !0 === this._verifyCardInProgress
      ? new ff(fP.THREEDS_AUTHENTICATION_IN_PROGRESS)
      : (e.nonce ? e.amount || (n = "an amount") : (n = "a nonce"),
        n || (n = this._checkForFrameworkSpecificVerifyCardErrors(e, t)),
        n)
      ? new ff({
          type: fP.THREEDS_MISSING_VERIFY_CARD_OPTION.type,
          code: fP.THREEDS_MISSING_VERIFY_CARD_OPTION.code,
          message: "verifyCard options must include " + n + ".",
        })
      : null;
  }),
  (fM.prototype.initializeChallengeWithLookupResponse = function (e, t) {
    var n = this;
    return (
      (t = t || {}),
      (this._lookupPaymentMethod = e.paymentMethod),
      (n._verifyCardPromisePlus = n._verifyCardPromisePlus || new fv()),
  ...
  (fM.prototype._handleLookupResponse = function (e, t) {
    var n,
  ...
  (fM.prototype._onLookupComplete = function (e) {
    return (
      (this._lookupPaymentMethod = e.paymentMethod),
      (this._verifyCardPromisePlus = new fv()),
      fE.resolve(e)
    );
  }),
  (fM.prototype._formatAuthResponse = function (e, t) {
    return {
      nonce: e.nonce,
      type: e.type,
      binData: e.binData,
  ...
  (fM.prototype._formatVerifyCardOptions = function (e) {
    return fm({}, e);
  }),
  (fM.prototype._formatLookupData = function (e) {
    var t = { amount: e.amount };
    return fE.resolve(t);
  }),
  (fM.prototype._handleV1AuthResponse = function (e) {
  ...
  (fM.prototype._setupV1Bus = function (e) {
    ...
    return (
      ...
      a.on(fI.AUTHENTICATION_COMPLETE, e.handleAuthResponse),
      a
    );
  }),
  (fM.prototype._setupV1Iframe = function (e) {
    return fC({
      src:
        this._assetsUrl +
      ...
      height: fx,
      width: fF,
      name: fT.LANDING_FRAME_NAME + "_" + this._v1Bus.channel,
      title: "3D Secure Authorization Frame",
    });
  }),
  (fM.prototype._setupV1Elements = function (e) {
    (this._v1Bus = this._setupV1Bus(e)),
      (this._v1Iframe = this._setupV1Iframe(e));
  }),
  (fM.prototype._teardownV1Elements = function () {
  ...
  (fM.prototype.teardown = function () {
    return (
      fy.sendEvent(this._createPromise, "three-d-secure.teardown-completed"),
...
(fk.prototype = Object.create(fL.prototype, { constructor: fk })),
  ...
  (fk.prototype._formatVerifyCardOptions = function (e) {
    var t = fL.prototype._formatVerifyCardOptions.call(this, e);
    return (
      (t.addFrame = fS(e.addFrame)),
      (t.removeFrame = fS(e.removeFrame)),
  ...
  (fk.prototype._formatLookupData = function (e) {
    var t = this;
    return fL.prototype._formatLookupData.call(this, e).then(function (n) {
      return (
        e.customer &&
...
function f0(e) {
  fV.call(this, e),
    ...
    (this._getDfReferenceIdPromisePlus = new fQ()),
...
(f0.prototype = Object.create(fV.prototype, { constructor: f0 })),
  (f0.events = fY(
    [
      "LOOKUP_COMPLETE",
      "CUSTOMER_CANCELED",
  ...
  (f0.prototype.setUpEventListeners = function (e) {
    this.on(f0.events.LOOKUP_COMPLETE, function (t, n) {
      e("lookup-complete", t, n);
    }),
      this.on(f0.events.CUSTOMER_CANCELED, function () {
        e("customer-canceled");
      }),
      this.on(f0.events["UI.CLOSE"], function () {
        e("authentication-modal-close");
      }),
      this.on(f0.events["UI.RENDER"], function () {
        e("authentication-modal-render");
      }),
      this.on(f0.events["UI.RENDERHIDDEN"], function () {
        e("authentication-modal-render-hidden");
      }),
      this.on(f0.events["UI.LOADING.CLOSE"], function () {
        e("authentication-modal-loader-close");
      }),
      this.on(f0.events["UI.LOADING.RENDER"], function () {
        e("authentication-modal-loader-render");
      });
  }),
  (f0.prototype.prepareLookup = function (e) {
    var t = fz({}, e),
      n = this;
    return this.getDfReferenceId()
      ...
      .then(function () {
        return (
          ...
          (t.braintreeLibraryVersion = "braintree/web/" + fX),
          t
        );
      });
  }),
  (f0.prototype.initializeChallengeWithLookupResponse = function (e, t) {
    return this.setupSongbird().then(
      function () {
        return fV.prototype.initializeChallengeWithLookupResponse.call(
          this,
          e,
          t
        );
  ...
  (f0.prototype.initiateV1Fallback = function (e) {
    (this._useV1Fallback = !0),
      this._removeSongbirdListeners(),
      fj.sendEvent(this._createPromise, "three-d-secure.v1-fallback." + e),
      this._songbirdPromise && this._songbirdPromise.resolve();
  }),
  (f0.prototype._triggerCardinalBinProcess = function (e) {
    var t = this,
      n = Date.now();
    return e
  ...
  (f0.prototype.transformBillingAddress = function (e, t) {
    return (
      t &&
        (f2(t, e, "billing"),
  ...
  (f0.prototype.transformShippingAddress = function (e) {
    var t = e.shippingAddress;
    return t && (f2(t, e, "shipping"), delete e.shippingAddress), e;
  }),
  (f0.prototype._createV1IframeModalElement = function (e) {
  ...
  (f0.prototype._createV1IframeModal = function (e) {
    ...
    function a() {
      t.parentNode.removeChild(t),
        i.cancelVerifyCard(fK.THREEDS_CARDINAL_SDK_CANCELED),
  ...
  (f0.prototype._addV1IframeToPage = function () {
    document.body.appendChild(this._v1Modal);
  }),
  (f0.prototype._handleAuthResponseFromV1Fallback = function (e) {
    this._teardownV1Elements(),
      this._v1Modal.parentNode.removeChild(this._v1Modal),
      this._handleV1AuthResponse(e);
  }),
  (f0.prototype._presentChallengeWithV1Fallback = function (e) {
    var t = this;
    this._setupV1Elements({
      lookupResponse: e,
      showLoader: !0,
  ...
  (f0.prototype.setupSongbird = function (e) {
    var t = this,
      n = Date.now();
    return (
      this._songbirdPromise ||
        ((e = e || {}),
        (this._songbirdPromise = new fQ()),
          ...
          .then(function () {
            return window.Cardinal
              ...
              : ((t._v2SetupFailureReason = "cardinal-global-unavailable"),
                fq.reject(new fH(fK.THREEDS_CARDINAL_SDK_SETUP_FAILED)));
          })
          .catch(function (e) {
            var n = fB(e, {
              type: fK.THREEDS_CARDINAL_SDK_SETUP_FAILED.type,
              code: fK.THREEDS_CARDINAL_SDK_SETUP_FAILED.code,
              message: fK.THREEDS_CARDINAL_SDK_SETUP_FAILED.message,
            });
  ...
  (f0.prototype._configureCardinalSdk = function (e) {
    var t = this;
      ...
      .then(function (n) {
        ...
        f1.forEach(function (e) {
          t.setCardinalListener(e, function () {
            t._emit(f0.events[e.toUpperCase()]);
          });
        }),
  ...
  (f0.prototype.setCardinalListener = function (e, t) {
    this._cardinalEvents.push(e), window.Cardinal.on(e, t);
  }),
  (f0.prototype._setupFrameworkSpecificListeners = function () {}),
  (f0.prototype._createCardinalConfigurationOptions = function (e) {
  ...
  (f0.prototype._loadCardinalScript = function (e) {
    var t = this,
      n = fG.CARDINAL_SCRIPT_SOURCE.sandbox;
    return this._waitForClient()
      .then(function () {
        var r =
          "production" ===
        ...
        return (
          ...
          r && (n = fG.CARDINAL_SCRIPT_SOURCE.production),
          fW.loadScript({ src: n })
        );
      })
      .catch(function (e) {
        return (
          ...
          fq.reject(fB(e, fK.THREEDS_CARDINAL_SDK_SCRIPT_LOAD_FAILED))
        );
      });
  }),
  (f0.prototype._createPaymentsSetupCompleteCallback = function () {
    var e = this;
    return function (t) {
  ...
  (f0.prototype.getDfReferenceId = function () {
    return this._getDfReferenceIdPromisePlus;
  }),
  (f0.prototype._performJWTValidation = function (e, t) {
    var n = this,
    ...
    return (
      a &&
        ...
        a === f$ && this._emit(f0.events.CUSTOMER_CANCELED)),
      fj.sendEvent(
        this._createPromise,
      ...
      this._waitForClient()
        ...
        .catch(function (e) {
          var t = new fH({
            type: fK.THREEDS_JWT_AUTHENTICATION_FAILED.type,
            code: fK.THREEDS_JWT_AUTHENTICATION_FAILED.code,
            message: fK.THREEDS_JWT_AUTHENTICATION_FAILED.message,
            details: { originalError: e },
          });
          return (
            fj.sendEvent(
  ...
  (f0.prototype._createPaymentsValidatedCallback = function () {
    var e = this;
    return function (t, n) {
      var r;
      if (e._useV1Fallback) {
      ...
      switch (t.ActionCode) {
        ...
        case "ERROR":
          switch (
            ...
            case 10001:
            case 10002:
              r = new fH(fK.THREEDS_CARDINAL_SDK_SETUP_TIMEDOUT);
              break;
            case 10003:
            case 10007:
            case 10009:
              r = new fH(fK.THREEDS_CARDINAL_SDK_RESPONSE_TIMEDOUT);
              break;
            case 10005:
            case 10006:
              r = new fH(fK.THREEDS_CARDINAL_SDK_BAD_CONFIG);
              break;
            case 10008:
            case 10010:
              r = new fH(fK.THREEDS_CARDINAL_SDK_BAD_JWT);
              break;
            case 10011:
              fj.sendEvent(
                e._createPromise,
                ...
                (r = new fH(fK.THREEDS_CARDINAL_SDK_CANCELED));
              break;
            default:
              r = new fH(fK.THREEDS_CARDINAL_SDK_ERROR);
          }
          (r.details = {
            originalError: {
              code: t.ErrorNumber,
  ...
  (f0.prototype._checkForVerifyCardError = function (e, t) {
    return fV.prototype._checkForVerifyCardError.call(this, e, t);
  }),
  (f0.prototype._checkForFrameworkSpecificVerifyCardErrors = function (e, t) {
    var n;
    return (
  ...
  (f0.prototype._formatVerifyCardOptions = function (e) {
    var t = fV.prototype._formatVerifyCardOptions.call(this, e),
      n = t.additionalInformation || {};
    return (
      (n = this.transformBillingAddress(n, e.billingAddress)),
      (n = this.transformShippingAddress(n)),
      e.onLookupComplete && (t.onLookupComplete = fU(e.onLookupComplete)),
  ...
  (f0.prototype._onLookupComplete = function (e, t) {
    var n = this;
    return fV.prototype._onLookupComplete.call(this, e).then(function (e) {
      return new fq(function (r, i) {
        ...
        (e.requiresUserAuthentication = Boolean(e.lookup && e.lookup.acsUrl)),
          ...
          t.onLookupComplete
            ...
            : n._emit(f0.events.LOOKUP_COMPLETE, e, a);
      });
    });
  }),
  (f0.prototype._presentChallenge = function (e) {
  ...
  (f0.prototype._formatLookupData = function (e) {
    var t = this;
    return fV.prototype._formatLookupData.call(this, e).then(function (n) {
      return (
  ...
  (f0.prototype.cancelVerifyCard = function (e) {
    var t = this;
    return fV.prototype.cancelVerifyCard.call(this).then(function (n) {
      return (
        t._verifyCardPromisePlus &&
          ((e = e || new fH(fK.THREEDS_VERIFY_CARD_CANCELED_BY_MERCHANT)),
          t._verifyCardPromisePlus.reject(e)),
        n
      );
    });
  }),
  (f0.prototype._removeSongbirdListeners = function () {
    this._cardinalEvents.forEach(function (e) {
      window.Cardinal.off(e);
    }),
      (this._cardinalEvents = []);
  }),
  (f0.prototype.teardown = function () {
    return (
      window.Cardinal && this._removeSongbirdListeners(),
      fV.prototype.teardown.call(this)
    );
  });
var f3 = f0,
  f4 = f3;
...
(f5.prototype = Object.create(f4.prototype, { constructor: f4 })),
  (f5.prototype._createV1IframeModalElement = function (e) {
    var t = document.createElement("div"),
      n = Boolean(
        this._createOptions &&
...
(f8.prototype = Object.create(f7.prototype, { constructor: f7 })),
  (f8.prototype._createV1IframeModalElement = function (e) {
    var t = document.createElement("div");
    return (
      (t.innerHTML =
  ...
  (f8.prototype._createCardinalConfigurationOptions = function (e) {
    var t = f7.prototype._createCardinalConfigurationOptions.call(this, e);
...
(Ei.prototype = Object.create(Ee.prototype, { constructor: Ee })),
  (Ei.events = Er(
    ["AUTHENTICATION_IFRAME_AVAILABLE"],
    "inline-iframe-framework:"
  )),
  (Ei.prototype.setUpEventListeners = function (e) {
    Ee.prototype.setUpEventListeners.call(this, e),
      this.on(Ei.events.AUTHENTICATION_IFRAME_AVAILABLE, function (t, n) {
        e("authentication-iframe-available", t, n);
      });
  }),
  (Ei.prototype._createCardinalConfigurationOptions = function (e) {
    var t = Ee.prototype._createCardinalConfigurationOptions.call(this, e);
    return (t.payment.framework = "inline"), t;
  }),
  (Ei.prototype._addV1IframeToPage = function () {
    this._emit(
      Ei.events.AUTHENTICATION_IFRAME_AVAILABLE,
      { element: this._v1Modal },
      function () {}
    );
  }),
  (Ei.prototype._setupFrameworkSpecificListeners = function () {
    this.setCardinalListener("ui.inline.setup", this._onInlineSetup.bind(this));
  }),
  (Ei.prototype._onInlineSetup = function (e, t, n, r) {
    var i, a;
    if (
      (e && t
        ? "CCA" !== t.paymentType
      ...
      r(new Et(En.THREEDS_INLINE_IFRAME_DETAILS_INCORRECT));
      return;
    }
...
Em.createChild(Ef),
  (Ef.prototype.verifyCard = function (e) {
    var t;
    return (
  ...
  (Ef.prototype.initializeChallengeWithLookupResponse = function (e) {
    return (
      "string" == typeof e && (e = JSON.parse(e)),
      this._framework.initializeChallengeWithLookupResponse(e)
    );
  }),
  (Ef.prototype.prepareLookup = function (e) {
    return this._framework.prepareLookup(e).then(function (e) {
      return JSON.stringify(e);
    });
  }),
  (Ef.prototype.cancelVerifyCard = function () {
    return this._framework.cancelVerifyCard();
  }),
  (Ef.prototype.teardown = function () {
    return (
      Eh(this, Eu(Ef.prototype).concat(Eu(Em.prototype))),
      this._framework.teardown()
    );
  });
var EE = Ep.wrapPrototype(Ef),
  E_ = EE,
  Ev = c1.isHTTPS,
  Eg = ig,
  EP = ix,
...
function EO(e) {
  ...
  return Eg.verify({
    ...
    var n = EC.create(e.authorization),
      r = Ex(e),
      i = EP.create({
        authorization: e.authorization,
        client: e.client,
        ...
        return ((e.client = t),
        a.threeDSecureEnabled || (n = EA.THREEDS_NOT_ENABLED),
        "TOKENIZATION_KEY" === i.authorizationType &&
          (n = EA.THREEDS_CAN_NOT_USE_TOKENIZATION_KEY),
        "production" !== a.environment ||
          Ev() ||
          (n = EA.THREEDS_HTTPS_REQUIRED),
        "legacy" === r ||
          ...
          (n = EA.THREEDS_NOT_ENABLED_FOR_V2)),
        n)
          ? ED.reject(new Eb(n))
          : (ET.sendEvent(e.client, "three-d-secure.initialized"), t);
      }),
      a = new E_({
        client: e.client,
        assetsUrl: n,
...
function Ex(e) {
  ...
  switch (t) {
    ...
    default:
      throw new Eb({
        code: EA.THREEDS_UNRECOGNIZED_VERSION.code,
        type: EA.THREEDS_UNRECOGNIZED_VERSION.type,
        message:
          "Version `" +
          e.version +
...
var EF = { create: EN(EO), VERSION: EI },
  EM = E.assign,
  Ew = EF,
  EL = "03",
  ES = [
...
function Ek(e, t) {
  (this._client = e),
    (this._model = t),
    (this._config = EM({}, t.merchantConfiguration.threeDSecure));
}
(Ek.prototype.initialize = function () {
  var e = this,
    t = { client: this._client, version: 2 };
  return (
    this._config.cardinalSDKConfig &&
      (t.cardinalSDKConfig = this._config.cardinalSDKConfig),
    Ew.create(t).then(function (t) {
      (e._instance = t),
  ...
  (Ek.prototype.verify = function (e, t) {
    var n = EM({ amount: this._config.amount }, t, {
      nonce: e.nonce,
      bin: e.details.bin,
    ...
    return (
      ...
      (n.additionalInformation.acsWindowSize =
        n.additionalInformation.acsWindowSize || EL),
      this._instance.verifyCard(n)
    );
  }),
  (Ek.prototype.updateConfiguration = function (e, t) {
    this._config[e] = t;
  }),
...
var ER = Ek,
  ...
  E6 = [Eq.paypal, Eq.paypalCredit, Eq.applePay, Eq.googlePay, "threeDSecure"],
  E7 = [Eq.paypal, Eq.paypalCredit, Eq.applePay, Eq.googlePay],
  E8 = {},
  E9 = "1.34.0";
function _e(e) {
  (this._client = e.client),
    (this._componentID = EJ()),
...
function _t(e) {
  ...
  return (
    ...
    e.type === EH.paymentMethodTypes.card && (t.description = e.description),
    e.type in E8 && (t.details.rawPaymentData = e.rawPaymentData),
...
(E8[EH.paymentMethodTypes.googlePay] = !0),
  (E8[EH.paymentMethodTypes.applePay] = !0),
  EW.createChild(_e),
  (_e.prototype._initialize = function (e) {
    var t,
      n,
      r = this,
      i =
    ...
    if (i) {
      if (
        ...
        Ez.sendEvent(r._client, "configuration-error"),
          e(
            new EB("Must only have one options.selector or options.container.")
          );
        return;
      }
    } else {
      Ez.sendEvent(r._client, "configuration-error"),
        e(new EB("options.container is required."));
      return;
    }
    if (
    ...
    (r._strings = EV({}, EQ.en)),
      r._merchantConfiguration.locale &&
        ((t =
          EQ[r._merchantConfiguration.locale] ||
          EQ[r._merchantConfiguration.locale.split("_")[0]]),
        (r._strings = EV(r._strings, t))),
      EZ() || (r._strings.endingIn = r._strings.endingIn.replace(/ΓÇó/g, "*")),
      r._merchantConfiguration.translations &&
        Object.keys(r._merchantConfiguration.translations).forEach(function (
          e
        ) {
          r._strings[e] = E$(r._merchantConfiguration.translations[e]);
        }),
      (n = Object.keys(r._strings).reduce(function (e, t) {
        var n = r._strings[t];
        return e.replace(RegExp("{{" + t + "}}", "g"), n);
      }, E3)),
      (r._dropinWrapper.innerHTML = E4 + n),
  ...
  (_e.prototype.updateConfiguration = function (e, t, n) {
    var r;
    if (-1 !== E6.indexOf(e)) {
      if ("threeDSecure" === e) {
      ...
      (r = this._mainView.getView(e)) &&
        ...
        -1 !== E7.indexOf(e) &&
          (this._removeUnvaultedPaymentMethods(function (t) {
            return t.type === EH.paymentMethodTypes[e];
          }),
          this._navigateToInitialView()));
    }
  }),
  (_e.prototype.getAvailablePaymentOptions = function () {
    return this._model.supportedPaymentOptions;
  }),
  (_e.prototype.clearSelectedPaymentMethod = function () {
    if (
  ...
  (_e.prototype._setUpDataCollector = function () {
    var e = this,
      t = EV({}, e._merchantConfiguration.dataCollector, { client: e._client });
    (this._dataCollector = new E1(t)),
      this._dataCollector
        .initialize()
        .then(function () {
  ...
  (_e.prototype._setUpThreeDSecure = function () {
    var e = this;
    (this._threeDSecure = new E0(this._client, this._model)),
      this._threeDSecure
        .initialize()
        .then(function () {
  ...
  (_e.prototype._setUpDependenciesAndViews = function () {
  ...
  (_e.prototype._removeUnvaultedPaymentMethods = function (e) {
    (e =
      e ||
      function () {
        return !0;
  ...
  (_e.prototype._navigateToInitialView = function () {
    this._mainView.primaryView.ID !== EG ||
      this._model.hasPaymentMethods() ||
      this._mainView.setPrimaryView(this._model.getInitialViewId());
  }),
  (_e.prototype._supportsPaymentOption = function (e) {
    return -1 !== this._model.supportedPaymentOptions.indexOf(e);
  }),
  (_e.prototype._disableErroredPaymentMethods = function () {
    var e,
    ...
    0 !== t.length &&
      ...
      t.forEach(
        function (t) {
          ...
          EU.add(r, "braintree-disabled"),
            r.removeEventListener("click", i),
            (o.innerHTML = EH.errors.DEVELOPER_MISCONFIGURATION_MESSAGE),
            console.error(a);
        }.bind(this)
      ));
  }),
  (_e.prototype._sendVaultedPaymentMethodAppearAnalyticsEvents = function () {
    var e,
      t,
      n = {},
    ...
    for (e = 0; e < r.length; e++)
      (t = r[e].type) in n ||
        ...
        Ez.sendEvent(
          this._client,
          "vaulted-" + EH.analyticsKinds[t] + ".appear"
        ));
  }),
  (_e.prototype._handleAppSwitch = function () {
  ...
  (_e.prototype.requestPaymentMethod = function (e) {
    var t = this;
    return (
      (e = e || {}),
      this._mainView
  ...
  (_e.prototype._shouldPerformThreeDSecureVerification = function (e) {
    return (
      !!this._threeDSecure &&
      null == e.liabilityShifted &&
      (e.type === EH.paymentMethodTypes.card ||
        (e.type === EH.paymentMethodTypes.googlePay &&
          !1 === e.details.isNetworkTokenized))
    );
  }),
  (_e.prototype._removeStylesheet = function () {
    var e = document.getElementById(EH.STYLESHEET_ID);
    e && e.parentNode.removeChild(e);
  }),
  (_e.prototype._injectStylesheet = function () {
    var e,
      t = { id: EH.STYLESHEET_ID };
    document.getElementById(EH.STYLESHEET_ID) ||
      ((e = this._client.getConfiguration().gatewayConfiguration.assetsUrl),
      (t.href = e + "/web/dropin/" + E9 + "/css/dropin.css"),
  ...
  (_e.prototype.teardown = function () {
    ...
    return (
      ...
      t
        ...
        .then(function () {
          return e ? EX.reject(e) : EX.resolve();
        })
    );
  }),
  (_e.prototype.isPaymentMethodRequestable = function () {
    return this._model.isPaymentMethodRequestable();
  }),
  (_e.prototype._removeDropinWrapper = function () {
    return (
...
function _r(e) {
  var t = e.parentNode;
  return t && "FORM" !== t.nodeName ? _r(t) : t;
}
var _i = { findParentForm: _r };
function _a(e) {
  var t = e.split("-");
  return [t.shift()]
    .concat(
...
function _m(e, t, n) {
  ...
  1 === r.length
    ? (e[i] = _y(n))
    : ((e[i] = e[i] || {}), _m(e[i], r.slice(1).join("."), n));
}
function _y(e) {
  try {
    return JSON.parse(e);
...
function _f(e, t) {
  ...
  if (t) {
    ...
    if (
      (((r = document.createElement("div")).id = "braintree-dropin-" + _l()),
      !(a = _d.findParentForm(t)))
    )
      throw new _c("No form found for script tag integration.");
    a.addEventListener("submit", function (e) {
      e.preventDefault();
    }),
      t.parentNode.insertBefore(r, t),
      (i = { authorization: n, container: r }),
      _u.forEach(function (e) {
        var n = t.getAttribute("data-" + e);
        null != n && _m(i, e, n);
      }),
      e(i).then(function (e) {
        _s.sendEvent(e._client, "integration-type.script-tag"),
          a.addEventListener("submit", function () {
            e.requestPaymentMethod(function (e, t) {
              e ||
                (_h("payment_method_nonce", t.nonce, a),
                t.deviceData && _h("device_data", t.deviceData, a),
                a.submit());
            });
          });
      });
  ...
  return e.authorization
    ? _v
        ...
        .then(function (t) {
          return (
            "TOKENIZATION_KEY" ===
            (t = _N(t)).getConfiguration().authorizationType
              ? _C.sendEvent(t, "started.tokenization-key")
              : _C.sendEvent(t, "started.client-token"),
            new _T(function (n, r) {
              new __({ merchantConfiguration: e, client: t })._initialize(
                function (e, t) {
                  if (e) {
                    r(e);
                    return;
    ...
    : _T.reject(new _b("options.authorization is required."));
}
function _N(e) {
  var t = e.getConfiguration();
  return (
    (t.analyticsMetadata.integration = _P.INTEGRATION),
    (t.analyticsMetadata.integrationType = _P.INTEGRATION),
    (t.analyticsMetadata.dropinVersion = _I),
...
var _O = { create: _A(_D), VERSION: _I },
  _x = _O;
