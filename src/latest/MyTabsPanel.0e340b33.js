import { _ as t, v as e, x as a, o as s, h as i } from "./preact.294f37c2.js";
import { bp as n, L as l, c6 as r, u as o, b9 as c } from "./index.6eeae9f8.js";
...
let m = "C4p8m",
  ...
  Z = a((t) => {
    let { isActive: e, numerated: a, revisionData: i, onClick: r } = t,
      { title: o, artist: c, defaultTrack: d } = i,
    ...
    return s(l, {
      ...
      children: [
        ...
        s("div", { className: S.artist, "data-field": "artist", children: c }),
      ],
    });
  }),
  _ = a(() =>
