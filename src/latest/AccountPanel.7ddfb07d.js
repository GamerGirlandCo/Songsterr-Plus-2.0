import { y as e, v as a, b as t, _ as n, c as s } from "./preact.294f37c2.js";
import {
  u as r,
  aq as i,
  b_ as o,
...
import { I as A, f as E, h as x } from "./Input.9e959f35.js";
import { c as S, d as w } from "./user.6707f531.js";
import { b as j } from "./google.ad6b2083.js";
function L(e, a) {
  switch (a.type) {
    case "process":
...
function X() {
  let { dispatch: t } = r(),
    [n, s] = e(L, { processing: !1, error: null }),
    l = async (e) => {
      e.preventDefault();
      try {
        s({ type: "process" });
...
let T = "Bab2hr",
  ...
  I = () => {
    let { dispatch: n, user: s } = r("user"),
      o = t(),
      p = t(),
      [m, g] = e(L, { processing: !1, error: null }),
      C = async (e) => {
        e.preventDefault();
        try {
          g({ type: "process" }),
          ...
          let e = await S(o.current.value, p.current.value);
    ...
    return a(
      ...
      a(
        ...
        a(
          "div",
          { className: q.actions },
          a(z, { title: "Save", processing: m.processing })
        )
      ),
      a(
        l,
...
var eN = "/static/media/devices.fde9455f.svg",
  ...
  eS = null,
  ew = null,
  ej = [eb, eB, ek, eP, ez, eA, eE, ex, eS, ew];
function eL(e) {
  let { onClick: t } = e,
    { gettext: n } = m(ej);
  return a(
...
var eU = "/static/media/plus.eaeb734d.svg",
  eO = null,
  eX = null,
  eT = null,
  eD = null,
  ...
  eY = null,
  eF = null,
  eM = [eO, eX, eT, eD, eR, eq, eI, e_, eY, eF];
let e$ = [g.BRAINTREE, g.APP_STORE, g.GOOGLE_PLAY];
function eG(e) {
  let { subscription: t } = e,
    ...
    i = null;
  if (t) {
    let e = e$.includes(t.type) && t.cancellationDate,
      r = t.type === g.COUPON,
      o = t.type === g.MANUAL,
  ...
  return a(
    ...
    a(
      ...
      a(
        "div",
        { className: ey.header },
        a("img", { src: eU, className: ey.icon, width: 144, height: 73 }),
        a(
          "div",
          { className: ey.text, id: "account-type" },
          a("span", { className: ey.secondary }, n("ACCOUNT TYPE")),
...
var eV = "/static/media/android.a60e0f77.svg";
function eH() {
  return a(
    "div",
    ...
    a(
      "div",
      { className: ey.header },
      a("img", { src: eV, className: ey.icon, width: 86, height: 65 }),
      a(
        "div",
        { className: ey.text, id: "account-type" },
...
var eJ = null,
  ...
  e0 = null,
  e5 = null,
  e4 = [eJ, eK, eQ, eW, eZ, e9, e1, e2, e0, e5];
class e3 extends n {
  name = s();
  email = s();
  constructor(e) {
    ...
    return a(
      ...
      a(
        ...
        a(
          ...
          f && a(eL, { onClick: this.onUpgradeClick }),
          f &&
            a(
              l,
              {
...
var e7 = y(e3, "user", "payment");
export { e7 as default };
