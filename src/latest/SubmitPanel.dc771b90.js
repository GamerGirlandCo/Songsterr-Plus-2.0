...
import { I as o } from "./Input.97539e13.js";
import { G as r, S as u } from "./UploadInstructions.44ed80b7.js";
import {
  u as c,
  bG as d,
  U as m,
...
import { A as C } from "./ActionButton.1cbc2cf9.js";
import { S as k } from "./Stub.4f8edbef.js";
let w = "Bv92k3",
  M = "Bv92se",
  ...
  N = () => {
    ...
    return i(
      ...
      i(
        "div",
        { className: Z.actions },
        i(C, { id: "submitTab", title: "Submit", processing: V })
      )
    );
  };
function y() {
      ...
      v &&
        i(
          ...
          i(
            ...
            i(
              V,
              { className: H.buttonGreen, to: g(r) },
