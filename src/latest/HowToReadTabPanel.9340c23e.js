import { x as e, p as t, h as a, v as i } from "./preact.294f37c2.js";
import {
  bQ as n,
  s as s,
  ay as o,
...
import { a as d, T as m } from "./TocPointer.ba7fd013.js";
...
var g = "/static/media/01-understanding-tab.fc95e054.svg",
  ...
  k = "/static/media/08-legato-slide.55e83cfd.svg",
  x = "/static/media/09-vibrato.108d30df.svg",
  ...
  Q = "/static/media/034-tapping.a74ff037.svg",
  U = "/static/media/035-tremolo.c7ee7c0f.svg",
  _ = "/static/media/htrgt-1.fc1b5282.svg",
  J = "/static/media/htrgt-2.112faf39.svg",
  ...
  ei = "/static/media/release-bend-dark.9a68aeea.svg",
  en = "/static/media/slide_a.b37f78d5.svg",
  es = "/static/media/slide_b.422cc585.svg",
  eo = "/static/media/legato-slide.47a48cdf.svg",
  el = "/static/media/vibrato.66938041.svg",
  er = "/static/media/wide-vibrato.bcc70d8a.svg",
  ec = "/static/media/let-ring.020d7e96.svg",
  eh = "/static/media/palm-mute.2d4b6104.svg",
  ed = "/static/media/ghost-note.944022f6.svg",
  em = "/static/media/dead-note.e1408a77.svg",
  eu = "/static/media/up-down-stroke.7794f731.svg",
  eg = "/static/media/natural-harmonics.1b50135e.svg",
  eb = "/static/media/polyphony.9ebb84ea.svg",
  ep = "/static/media/pinchHarmonic.a82dbdcd.svg",
  ef = "/static/media/bars.16cb2819.svg",
  ey = "/static/media/time-signature.2dda5a50.svg",
  ev = "/static/media/notesRest-1.31bb0682.svg",
  ew = "/static/media/notesRest-2.51140c68.svg",
  ek = "/static/media/notesRest-3.b5bed63f.svg",
  ex = "/static/media/notesRest-4.166dd62a.svg",
  eS = "/static/media/dots.628c6d0f.svg",
  eT = "/static/media/ties.d03189de.svg",
  eN = "/static/media/beams.e32d9379.svg",
  eH = "/static/media/triplets.615cd224.svg",
  eq = "/static/media/repeats.2792eb90.svg",
  eI = "/static/media/swingRhythm.e48178a6.svg",
  eB = "/static/media/alternate-endings.47273a72.svg",
  eR = "/static/media/mock.1494936b.svg",
  eA = "/static/media/plusBigMock.552c8052.svg",
  eE = "/static/media/plusSmallMock.dbc5f818.svg",
  eL = "/static/media/accented.cf8cb980.svg",
  ej = "/static/media/heavilyAccented.cc870d84.svg",
  eP = "/static/media/staccato.5b1bdfa5.svg",
  eC = "/static/media/tapping.934f8c42.svg",
  eM = "/static/media/tremolo.c8d3897a.svg";
let eD = { img: eR, plusBig: eA, plusSmall: eE },
  e$ = {
    understandingTab: {
      icon: g,
      ...
      content: [
        [
          ...
          { img: J, style: { margin: "auto 0 auto auto" } },
        ],
      ],
    },
    chord: {
    ...
    timeSignature: {
      ...
      content: [
        [
          ...
          { img: ey, style: { padding: 0, margin: "auto" } },
        ],
      ],
    },
    notesAndRests: {
...
var ti = null,
  ...
  td = null,
  tm = null,
  tu = [ti, tn, ts, to, tl, tr, tc, th, td, tm];
function tg(e, t) {
  if (!e) return;
  let a = [],
    i = [],
...
function tb(e, t, a) {
  return [
    i(
      "header",
      { className: ta.featureHeader, "data-id": t },
      i("h3", { className: ta.featureTitle }, e.name),
      a && i("a", { id: `anchor-${t}`, className: ta.hidden }, e.name)
    ),
    tp(e),
  ];
}
    ...
    e.content.forEach((a) => {
      ...
      a.forEach((t) => {
        t.img
          ...
          : t.url
          ? n.push(i(h, { className: ta.featureLink, to: t.url }, t.text))
          : n.push(i("p", { className: ta.featureBody }, t.text));
      }),
        t.push(i("div", { className: ta.featureContainer }, n));
    }),
    t
  );
}
function tf(e, t) {
  ...
  for (let n in e)
    a.push(
      i(
        "a",
        { className: ta.tocItem, href: `#${n}`, onClick: () => t(n) },
        i("img", { src: e[n].icon, className: ta.tocIcon }),
        i("span", { className: ta.tocName }, e[n].name)
      )
    );
  return a;
}
function ty(e, t) {
        ...
        (o < e &&
          (n
            ? l.push(
                i("img", {
                  src: eD.img,
                  className: 2 === o ? ta.mock : ta.mockBig,
                })
              )
            : l.push(
                i(
                  ...
                  {
                    to: "/a/wa/plus",
                    className: 2 === o ? ta.mock : ta.mockBigPlus,
                  },
                  i("img", { src: 2 === o ? eD.plusSmall : eD.plusBig })
                )
              )),
        s.push(
          i(
            "div",
            { className: ta.articleGroup, "data-section": `group-${r}` },
            l
          )
        ),
        (l = []),
  ...
  for (let t in e) {
    ...
    if (r > 1) {
      (o >= r || r != d) && c(r), (d = r), o++, l.push(tb(n, t, a));
      continue;
    }
    c(d),
      s.push(
        i("article", { className: ta.feature, "data-section": t }, tb(n, t, a))
      );
  }
  return c(d), s;
}
function tv(e) {
  let { gettext: n } = o(tu),
    ...
    v = l(b),
    w = !g && p.current && tg(r(e.tabFeatures, p.current, e.dispatch), e$);
  return (
    a(() => {
      ...
      i(
        ...
        !g &&
          ...
          i(
            ...
            i(
              "header",
              { className: ta.dynamicHeader },
              i(
                "h2",
                { className: ta.dynamicH2 },
                n("Symbols and icons in the current track:")
              ),
              i(
                "span",
                { className: ta.dynamicHeaderName },
                `${v.name} - ${v.instrument}`
              )
            ),
            ty(w, { hasIndex: !1, paid: c(y) })
          ),
        d("toc"),
        i(
          "section",
          { className: ta.toc, "data-section": "toc" },
          i("h2", { className: ta.tocHeader }, n("Table of Contents")),
          i("div", { className: ta.grid }, tf(e$, h))
        ),
        m("HowToReadTabPanel", "#toc"),
        i(
          "section",
          { className: ta.content },
          ty(e$, { hasIndex: !0, paid: c(y) })
        ),
        i("script", { type: "application/ld+json" }, ez())
      )
    )
  );
}
var tw = s(e(tv), "part", "meta", "user");
