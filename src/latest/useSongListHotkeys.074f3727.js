...
var E = "/static/media/plus-showroom-sidebar.5aeb8b9b.svg";
let k = "Bcr2ak",
  z = "Bcr2ak Bcr33f",
  S = "Bcr2ak Bcr1tq",
  A = "Bcr2c8",
...
let N = "B0cew",
  ...
  J = h + " Bp619r",
  Q = "Bp62wh",
  W = { showroom: "Bp6ta", inner: h + " Bp619r", plusBanner: "Bp62wh" },
  X = t((t) => {
    let { page: a, instrumentFilter: c } = t,
      { dispatch: l, ads: i } = o("ads"),
      r = l("curiosity/setConversionProps", {
        "Last referring link": "Panel Banner",
      });
    return (
      v("search_panel", { isTargeted: !1, page: a, instrumentFilter: c }),
      e(
        "div",
  ...
  ew = (t) => {
    ...
    l(() => {
      let e = (e) => {
        ...
        h = { up: e, down: t, space: c, tab: i, esc: l };
      return (
        s &&
          (window.hotKeysManager.bind(h, { onPanelPopup: !0 }, a),
          window.hotKeysManager.bindMeta("shift+tab", r, a)),
        () => {
          s &&
            (window.hotKeysManager.unbind(h, { onPanelPopup: !0 }, a),
            window.hotKeysManager.unbindMeta("shift+tab", a));
        }
      );
    }, [a, s]);
    let g = 0 !== v.indexOf(h) || s ? eg.active : "",
      b = `${eg.customSelect} ${s ? eg.opened : ""} ${u ? eg.left : ""}`,
      B = o ? d[0] : d[v.indexOf(h)] || h;
...
function ej(t) {
  ...
  let f = (e) => s(e),
    ...
    x = eM.space;
  return (
    "big" === h ? (x = eM.biggerSpace) : "small" === h && (x = eM.smallerSpace),
    e(
      "div",
      { className: eM.header },
      e("div", { className: x }, o && e("span", { className: eM.hash }, "#")),
      e(
        "div",
...
var e$ = null,
  ...
  eR = null,
  eV = null,
  eL = [e$, eD, eq, eF, eI, e_, eK, eH, eR, eV];
let eT = (t) => {
