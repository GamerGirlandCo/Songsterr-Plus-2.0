...
import { S as W } from "./SearchBox.94e72d54.js";
import { S as O } from "./Stub.4f8edbef.js";
import { P as z } from "./Panel.1b182ff5.js";
					...
					ew &&
						...
						t(
							...
							t(
								...
								{},
								t(F, ek),
								Z && X && t(D, { page: s.page, instrumentFilter: ea })
							),
							t(
								"div",
								{
