...
import {
  ...
  A as ye,
  c as fe
} from './NetworkError.129f1815.js'
import { S as ge } from './SWW.62100d17.js'
import { p as xe } from './ShowroomPlaceholder.48ae4617.js'
import './FileInput.d0451d36.js'
import './user.b94196d7.js'
import './DifficultyIndicator.38bdf6f8.js'
...
class ei {
  ...
  scroll (t, e, o) {
    if (
      ...
      const i =
        o ||
        (window.visualViewport ? window.visualViewport.pageTop : window.scrollY)
...
const ri = () =>
    zt(
      ...
      zt('path', {
        d:
          'M9.4 2.3l-.7 8.3c-.1.8-.8 1.4-1.6 1.4H2.9c-.8 0-1.5-.6-1.6-1.4L.6 2.3zM3 3.8c0-.2-.2-.4-.4-.4s-.4.2-.4.4l.4 7.1c0 .2.2.3.3.3.2 0 .4-.1.4-.3zm2.4 0c0-.2-.2-.4-.4-.4s-.4.2-.4.4l.1 7.1c0 .2.1.3.3.3.2 0 .3-.1.3-.3zm2.4 0c0-.2-.2-.4-.4-.4s-.4.2-.4.4l-.3 7.1c0 .2.2.3.4.3.1 0 .3-.1.3-.3zm2.2-2H0C0 1.3.3.9.8.9h2.4c.1-.5.4-.9.8-.9h1.8c.5 0 .9.4 1 .9h2.5c.4 0 .7.4.7.9z'
      })
    ),
...
class Si extends Dt {
  ...
  __init2 () {
    this.onTouchStart = t => {
      ...
      if ('tab_editor' === this.props.layer) return void this.handleTabEditor(t)
...
function Ti () {
  return zt(
    ...
    zt('path', {
      d:
        'M8 0h38a8 8 0 0 1 8 8v38a8 8 0 0 1-8 8H8a8 8 0 0 1-8-8V8a8 8 0 0 1 8-8z',
      fill: '#F1452D'
    }),
    zt('path', {
      d:
        'M23.5 31V12a3 3 0 0 1 3-3h1a3 3 0 0 1 3 3v19a3 3 0 0 1-3 3h-1a3 3 0 0 1-3-3zM23.5 42v-2a3 3 0 0 1 3-3h1a3 3 0 0 1 3 3v2a3 3 0 0 1-3 3h-1a3 3 0 0 1-3-3z',
      fill: '#FDE3DF'
    })
  )
}
...
//# sourceMappingURL=AppTab.ebcc6595.js.map
